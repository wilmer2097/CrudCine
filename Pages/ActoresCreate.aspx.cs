...
{
    public partial class ActoresCreate : System.Web.UI.Page

    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["op"] != null)
                {
                    ...
                    {
                        case "C":
                            this.lbltitulo.Text = "Ingresar nuevo actor";
                            this.BtnCreate.Visible = true;
                            break;
                        case "R":
                            this.lbltitulo.Text = "Consulta de actor";
                            break;
                        case "U":
                            this.lbltitulo.Text = "Modificar actor";
                            this.BtnUpdate.Visible = true;
                            break;
                        case "D":
                            this.lbltitulo.Text = "Eliminar actor";
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("sp_BuscarActor", con);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            da.SelectCommand.Parameters.Add("@Id_act", SqlDbType.Int).Value = sID;
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_CrearActor", con);
            con.Open();
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_actualizarActor", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@Id_act", SqlDbType.Int).Value = sID;
            cmd.Parameters.Add("@Nom", SqlDbType.VarChar).Value = tbnombre.Text;
            cmd.Parameters.Add("@Ape", SqlDbType.VarChar).Value = tbapellido.Text;
            cmd.Parameters.Add("@Fecha_Nac", SqlDbType.Date).Value = tbdate.Text;
            cmd.Parameters.Add("@Nac", SqlDbType.VarChar).Value = tbnacionalidad.Text;
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_deleteActor", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@Id_act", SqlDbType.Int).Value = sID;
            cmd.ExecuteNonQuery();
