...
namespace CrudCine.Pages
{
    public partial class index : System.Web.UI.Page
    {
        ...
        void CargarTabla() 
        {
            SqlCommand cmd = new SqlCommand("sp_mostrarPelis", con);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            gvpeliculas.DataSource = dt;
        ...
        {
            Response.Redirect("~/pages/Create.aspx?op=C");
        }
        ...
        {
            Response.Redirect("~/pages/Actores.aspx?op=C");
        }

        protected void BtnCreateD_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/pages/Directores.aspx?op=C");
        }
    }
}